...
export const STORY_EVENTS = [
  ...
  },
  {
    ...
    trigger: 50,
    title: 'Hidden Cache',
    body: 'Tucked beneath a collapsed cart, you find a rusted metal box. The latch is stiff, but inside are untouched provisions and a rare hybrid card. A massive relief.',
    asset: 'event_cache', // Updated asset to legendary cache
    fearDelta: -15,
    crowPressure: 0,
    cardRewardDelta: 1,
    isJournal: false,
  ...
  },
  {
    ...
    body: "The scratching isn't the only sound. You hear your own name, whispered by a thousand dry, rattling voices from the bushes.",
    asset: 'Voices',
    fearDelta: 20,
    crowPressure: 5,
    isJournal: true,
  },
  {
    ...
    levelId: 'the_warning',
    trigger: 80,
    title: 'The Shadows Stretch',
    body: "The trees are getting longer. The ground is sinking. You can feel the island's pulse beneath your feet, and it's beating faster.",
